...
class AdvancedContractRAG:
    ...
    def extract_key_information(self) -> Dict:
        ...
        extraction_prompt = """Please extract the following key information from the contract, answer concisely (if information not found, answer "Not mentioned"):
...
Please answer in the following format (one item per line, answer directly after colon):
Rent Amount: xxx
Lease Duration: xxx
...
Parking: xxx"""
        ...
        # Get relevant document chunks (take top 8 most relevant chunks for speed)
        try:
...
{extraction_prompt}"""
            ...
            # Directly call LLM (not using conversation chain, faster)
